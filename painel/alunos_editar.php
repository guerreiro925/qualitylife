  ...
  <body class="nav-md">
    <div class="container body">
      <div class="main_container">
          ...
          <div class="left_col scroll-view">
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                <li class="active"><a href="#0.php"><i class="fa fa-users"></i> Aluno <span class="fa fa-chevron-down"></span></a>
		...
		<?php
	$id = $_GET['id'];
	$resultado = mysql_query("SELECT * FROM aluno WHERE idAluno = '$id'");
	while($dados = mysql_fetch_array($resultado)){
	?>		  
				  
                    <form class="form-horizontal form-label-left" action="controlador.php?acao=editar_aluno" method="post" enctype="multipart/form-data" novalidate>
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" name="nome" id="nome" value="<?php echo $dados['nome'];?>" class="form-control col-md-7 col-xs-12" placeholder="Preencha um nome.." required type="text">
                        </div>
                      </div>
					  ...
					  <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <select name="usuario" id="usuario" class="form-control col-md-7 col-xs-12 required" required>
						  <option selected value>Selecione um Usuário</option>
						  <?php

	$consulta = mysql_query("SELECT * FROM usuario WHERE deletar != 1");

while ($dadosB = mysql_fetch_array($consulta))
	{
					?>
                        	<option value="<?php echo $dadosB['idUsuario'];?>"><?php echo $dadosB['usuario'];?></option>
                        <?php } ?>
						  </select>
                        </div>
                      </div>
					  ...
					  <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="">Telefone:</label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" name="telefone" id="telefone" value="<?php echo $dados['telefone'];?>" class="form-control col-md-7 col-xs-12" placeholder="Preencha um telefone.." required>
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <select name="turma" id="turma" class="form-control col-md-7 col-xs-12 required" required>
						  <option selected value>Selecione uma turma</option>
						  <?php

	$consultaB = mysql_query("SELECT * FROM turma WHERE deletar != 1");

while ($dadosC = mysql_fetch_array($consultaB))
	{
					?>
                        	<option value="<?php echo $dadosC['nome'];?>"><?php echo $dadosC['nome'];?></option>
                        <?php } ?>
						  </select>
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        <div class="col-md-6 col-md-offset-3">
						  ...
						  <button type="reset" class="btn btn-primary" onClick="window.location.href='alunos.php'">Voltar</button>
