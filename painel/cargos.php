            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                  <a href="cargos_incluir.php" style="color: #fff">
					<p class="btn btn-dark">
                        <i class="fa fa-plus-circle"></i>&nbsp;Adicionar cargo
					</p>
				  </a>
...
<?php
$consulta = mysql_query("SELECT * FROM cargo WHERE deletar != '1'");
while ($dados = mysql_fetch_array($consulta))
{

	?>	
                        <tr>
                        	<th><?php echo $dados['idCargo']; ?></th>
                        	<th><?php echo $dados['descricao']; ?></th>
                            <td><a href="cargos_editar.php?id=<?php echo $dados['idCargo'];?>"><i class="fa fa-pencil-square" style="font-size: 20px"></i></a><a href="controlador.php?acao=excluir_cargo&id=<?php echo $dados['idCargo'];?>"><i class="fa fa-trash-o" style="font-size: 20px"></i></a></td>
                        </tr>
<?php } ?>
                    </table>
