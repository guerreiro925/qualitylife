              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_content">
                    ...
                    <form class="form-horizontal form-label-left" action="controlador.php?acao=add_noticia" method="post" enctype="multipart/form-data" novalidate>
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" name="titulo" id="titulo"  class="form-control col-md-7 col-xs-12" placeholder="Preencha um título.." required type="text">
                        </div>
                      </div>
					  ...
					  <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" name="resumo" id="resumo"  class="form-control col-md-7 col-xs-12" placeholder="Preencha um resumo.." required type="text">
                        </div>
                      </div>
					  ...
					  <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
						  <input type="file" name="imagem" id="imagem"  class="form-control col-md-7 col-xs-12" placeholder="Preencha uma imagem.." required><br>
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <textarea type="text" name="conteudo" id="message1" rows="3"  class="form-control col-md-7 col-xs-12" placeholder="Preencha o conteúdo.." required type="text"></textarea>
