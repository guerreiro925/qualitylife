            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                  <a href="turmas_incluir.php" style="color: #fff">
...
<?php
$consulta = mysql_query("SELECT * FROM turma WHERE deletar != '1'");
while ($dados = mysql_fetch_array($consulta))
{

	?>	
                        <tr>
                        	<th><?php echo $dados['idTurma']; ?></th>
                        	<th><?php echo $dados['nome']; ?></th>
                            <td><a href="turmas_editar.php?id=<?php echo $dados['idTurma'];?>"><i class="fa fa-pencil-square" style="font-size: 20px"></i></a><a href="controlador.php?acao=excluir_turma&id=<?php echo $dados['idTurma'];?>"><i class="fa fa-trash-o" style="font-size: 20px"></i></a></td>
                        </tr>
<?php } ?>
                    </table>
