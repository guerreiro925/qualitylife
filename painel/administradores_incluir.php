              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_content">
                    ...
                    <form class="form-horizontal form-label-left" action="controlador.php?acao=add_administrador" method="post" enctype="multipart/form-data" novalidate>
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" name="usuario" id="usuario" class="form-control col-md-7 col-xs-12"placeholder="Preencha o usuário.." required type="text">
                        </div>
                      </div>
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="password" name="senha" id="senha" data-validate-length="1,2,3,4,5,6" placeholder="Preencha a senha.." required class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
