              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_content">
                    ...
                    <form class="form-horizontal form-label-left" action="controlador.php?acao=add_aluno" method="post" enctype="multipart/form-data" novalidate>
					  ...
					  <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" name="nome" id="nome" class="form-control col-md-7 col-xs-12" placeholder="Preencha um nome.." required type="text">
                        </div>
                      </div>
...
while ($dadosB = mysql_fetch_array($consulta))
	{
					?>
					  ...
					  <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="date" name="data" id="data" class="form-control col-md-7 col-xs-12" placeholder="Preencha uma data.." required type="text">
                        </div>
                      </div>
					  ...
					  <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" name="telefone" id="telefone" class="form-control col-md-7 col-xs-12" placeholder="Preencha um telefone.." required>
...
while ($dadosC = mysql_fetch_array($consultaB))
	{
					?>
					  ...
					  <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
						  <input type="file" name="imagem" id="imagem" class="form-control col-md-7 col-xs-12" placeholder="Preencha uma imagem..">
                        </div>
                      </div>
