            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                  <a href="funcionarios_incluir.php" style="color: #fff">
					<p class="btn btn-dark">
                        <i class="fa fa-plus-circle"></i>&nbsp;Adicionar funcionário
					</p>
				  </a>
...
<?php
$consulta = mysql_query("SELECT * FROM funcionario WHERE deletar != '1'");
while ($dados = mysql_fetch_array($consulta))
{
	...
	?>	
                        <tr>
							...
							<td><a href="funcionarios_editar.php?id=<?php echo $dados['idFuncionario'];?>"><i class="fa fa-pencil-square" style="font-size: 20px"></i></a><a href="controlador.php?acao=excluir_funcionario&id=<?php echo $dados['idFuncionario'];?>"><i class="fa fa-trash-o" style="font-size: 20px"></i></a></td>
                        </tr>
<?php } ?>
                    </table>
