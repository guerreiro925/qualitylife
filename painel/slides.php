            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                  <a href="slides_incluir.php" style="color: #fff">
					<p class="btn btn-dark">
                        <i class="fa fa-plus-circle"></i>&nbsp;Adicionar slide
					</p>
				  </a>
                    <table id="datatable-responsive" class=" table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                      <thead>
                        <tr>
							...
							<th class="contoth">Descrição</th>
                          	<th class="contoth">Imagem</th>
							<th class="contoth">Ações</th>
                        </tr>
                      </thead>
<?php
$consulta = mysql_query("SELECT * FROM slide WHERE deletar != '1'");
while ($dados = mysql_fetch_array($consulta))
{

	?>	
                        <tr>
                        	<th><?php echo $dados['idSlide']; ?></th>
							<th><?php echo $dados['descricao']; ?></th>
                        	<th><img src="<?php echo $dados['imagem']; ?>" width="60" height="60" class="img-responsive"></th>
							<td><a href="slides_editar.php?id=<?php echo $dados['idSlide'];?>"><i class="fa fa-pencil-square" style="font-size: 20px"></i></a><a href="controlador.php?acao=excluir_slide&id=<?php echo $dados['idSlide'];?>"><i class="fa fa-trash-o" style="font-size: 20px"></i></a></td>
                        </tr>
<?php } ?>
                    </table>
