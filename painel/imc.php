            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <a href="imc_incluir.php" style="color: #fff">
					<p class="btn btn-dark">
                        <i class="fa fa-plus-circle"></i>&nbsp;Adicionar imc
					</p>
					</a>
                    <table id="datatable-responsive" class=" table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                      <thead>
                        <tr>
                          	<th>Código</th>
                          	<th class="contoth">Pessoa</th>
							<th class="contoth">Cargo</th>
							<th class="contoth">Nome</th>
							<th class="contoth">Idade</th>
							<th class="contoth">Peso</th>
							<th class="contoth">Altura</th>
							<th class="contoth">Sexo</th>
							<th class="contoth">Resultado</th>
							<th class="contoth">Estado</th>
							<th>Ações</th>
                        </tr>
                      </thead>
<?php
$consulta = mysql_query("SELECT * FROM imc WHERE deletar != '1'");
while ($dados = mysql_fetch_array($consulta))
{

	?>	
                        <tr>
                        	<th><?php echo $dados['idImc']; ?></th>
                        	<th class="contod"><?php echo $dados['pessoa'];?></th>
							<th class="contod"><?php echo $dados['turma_cargo'];?></th>
							<th class="contod"><?php echo $dados['nome'];?></th>
							<th class="contod"><?php echo $dados['idade'];?></th>
							<th class="contod"><?php echo $dados['peso'];?></th>
							<th class="contod"><?php echo $dados['altura'];?></th>
							<th class="contod"><?php echo $dados['sexo'];?></th>
							<th class="contod"><?php echo $dados['resultado'];?></th>
							<th class="contod"><?php echo $dados['estado'];?></th>							
							<td><a href="imc_editar.php?id=<?php echo $dados['idImc'];?>"><i class="fa fa-pencil-square" style="font-size: 20px"></i></a><a href="controlador.php?acao=excluir_imc&id=<?php echo $dados['idImc'];?>"><i class="fa fa-trash-o" style="font-size: 20px"></i></a></td>
                        </tr>
<?php } ?>
                    </table>
