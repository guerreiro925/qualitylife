...
<!-- Mirrored from vendroid.venmond.com/ui-tabs-accordion.php by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 15 Oct 2016 19:32:37 GMT -->
...
<?php include("conexao.php");?>
    ...
    <link href="css/jquery.pnotify.css" media="screen" rel="stylesheet" type="text/css">    
          ...
          <div class="vd_head-section clearfix">
            <div class="vd_panel-header">
              <ul class="breadcrumb">
                ...
                <li><a href="ui-panels.html">UI</a> </li>
                ...
                <div class="panel widget">
                  ...
                  <div class="panel-body">
                    ...
                    <ul class="nav nav-pills nav-justified">
                      <li><a href="#administrador"  data-toggle="tab">Administrador</a></li><!-- << AQUI NO LUGAR DO 'tab1' você coloca php echo $dados[IDTABELA] -->
                    ...
                    <br/>
					<?php
$consulta = mysql_query("SELECT * FROM adm WHERE deletar != '0'");
while ($dados = mysql_fetch_array($consulta))
{
	...
	?>
                    <div class="tab-content  mgbt-xs-20">
                      ...
                      <div class="tab-pane active" id="administrador"> <?php echo $dados['usuario'];?> </div>
					...
					<?php
$consulta = mysql_query("SELECT * FROM aluno WHERE deletar != '0'");
while ($dados = mysql_fetch_array($consulta))
{
	...
	?>
                    <div class="tab-content  mgbt-xs-20">
                      ...
                      <div class="tab-pane active" id="aluno"> <?php echo $dados['nome'];?> </div>
...
<!-- Mirrored from vendroid.venmond.com/ui-tabs-accordion.php by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 15 Oct 2016 19:32:38 GMT -->
</html>