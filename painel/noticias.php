  ...
  <body class="nav-md">
    <div class="container body">
      <div class="main_container">
        ...
        <!-- page content -->
        <div class="right_col" role="main" style="max-height: auto;">
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                  <a href="noticias_incluir.php" style="color: #fff">
					<p class="btn btn-dark">
                        <i class="fa fa-plus-circle"></i>&nbsp;Adicionar notícia
					</p>
				  </a>
                    <table id="datatable-responsive" class=" table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                      <thead>
                        <tr>
							...
							<th class="contoth">Titulo</th>
                          	<th class="contoth">Resumo</th>
							<th class="contoth">Imagem</th>
							<th class="contoth">Conteúdo</th>
							<th class="contoth">Categoria</th>
							<th class="contoth">Data</th>
							<th class="contoth">Visualizações</th>
...
$idCategoria = $dados['idCategoria'];
	?>	
                        <tr>
                        	<th><?php echo $dados['idNoticia']; ?></th>
							<th><?php echo $dados['titulo']; ?></th>
                        	<th><?php echo $dados['resumo']; ?></th>
							<th><img src="<?php echo $dados['imagem']; ?>" width="60" height="60" class="img-responsive"></th>
							<th><?php echo $dados['conteudo']; ?></th>
                        	<td><?php $query  = mysql_query("SELECT * FROM categoria WHERE idCategoria ='$idCategoria'");
							...
							<th><?php echo $dados['contador']; ?></th>
							<td><a href="noticias_editar.php?id=<?php echo $dados['idNoticia'];?>"><i class="fa fa-pencil-square" style="font-size: 20px"></i></a><a href="controlador.php?acao=excluir_noticia&id=<?php echo $dados['idNoticia'];?>"><i class="fa fa-trash-o" style="font-size: 20px"></i></a></td>
                        </tr>
<?php } ?>
                    </table>
