            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                  <a href="alunos_incluir.php" style="color: #fff">
					<p class="btn btn-dark">
                        <i class="fa fa-plus-circle"></i>&nbsp;Adicionar aluno
					</p>
				  </a>
                    <table id="datatable-responsive" class=" table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                      <thead>
                        <tr>
							...
							<th class="contoth">Telefone</th>
							<th class="contoth">Turma</th>
							<th class="contoth">Imagem</th>
							<th class="contoth">Ações</th>
                        </tr>
                      </thead>
<?php
$consulta = mysql_query("SELECT * FROM aluno WHERE deletar != '1'");
...
$idUsuario = $dados['idUsuario'];
	...
	?>	
                        <tr>
							...
							<td><?php $query  = mysql_query("SELECT * FROM usuario WHERE idUsuario ='$idUsuario'");
							...
							<td><?php echo $dados['turma']; ?>
							</td>
							
							<td><img src="<?php echo $dados['imagem']; ?>" width="60" height="60" class="img-responsive"></td>
							<td><a href="alunos_editar.php?id=<?php echo $dados['idAluno'];?>"><i class="fa fa-pencil-square" style="font-size: 20px"></i></a><a href="controlador.php?acao=excluir_aluno&id=<?php echo $dados['idAluno'];?>"><i class="fa fa-trash-o" style="font-size: 20px"></i></a></td>
                        </tr>
<?php } ?>
                    </table>
