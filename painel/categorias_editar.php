  ...
  <body class="nav-md">
    <div class="container body">
      <div class="main_container">
		...
		<?php
	$id = $_GET['id'];
	$resultado = mysql_query("SELECT * FROM categoria WHERE idCategoria = '$id'");
	while($dados = mysql_fetch_array($resultado)){
	?>		  
				  
                    <form class="form-horizontal form-label-left" action="controlador.php?acao=editar_categoria" method="post" enctype="multipart/form-data" novalidate>
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" name="categoria" value="<?php echo $dados['nome'];?>" id="categoria" class="form-control col-md-7 col-xs-12" placeholder="Preencha nome do cargo.." required type="text">
                        </div>
                      </div>
