  ...
  <body class="nav-md">
    <div class="container body">
      <div class="main_container">
          ...
          <div class="left_col scroll-view">
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  <li class="active"><a href="funcionarios.php"><i class="zmdi zmdi-hc-2x zmdi-wrench"></i> Funcionário</a></li>
                </ul>
                <ul class="nav side-menu">
		...
		<?php
	$id = $_GET['id'];
	$resultado = mysql_query("SELECT * FROM funcionario WHERE idFuncionario = '$id'");
	while($dados = mysql_fetch_array($resultado)){
	?>		  
				  
                    <form class="form-horizontal form-label-left" action="controlador.php?acao=editar_funcionario" method="post" enctype="multipart/form-data" novalidate>
					  ...
					  <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="">Cargo:</label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <select name="cargo" id="cargo" class="form-control col-md-7 col-xs-12 required" required>
						  <option selected value>Selecione um Cargo</option>
						  <?php

	$consultaB = mysql_query("SELECT * FROM cargo WHERE deletar != 1");

while ($dadosC = mysql_fetch_array($consultaB))
	{
					?>
                        	<option value="<?php echo $dadosC['descricao'];?>"><?php echo $dadosC['descricao'];?></option>
                        <?php } ?>
						  </select>
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        <div class="col-md-6 col-md-offset-3">
                          ...
                          <button type="reset" class="btn btn-primary" onClick="window.location.href='funcionarios.php'">Voltar</button>
