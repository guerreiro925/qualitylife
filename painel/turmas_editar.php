  ...
  <body class="nav-md">
    <div class="container body">
      <div class="main_container">
		...
		<?php
	$id = $_GET['id'];
	$resultado = mysql_query("SELECT * FROM turma WHERE idTurma = '$id'");
	while($dados = mysql_fetch_array($resultado)){
	?>		  
				  
                    <form class="form-horizontal form-label-left" action="controlador.php?acao=editar_turma" method="post" enctype="multipart/form-data" novalidate>
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" name="turma" value="<?php echo $dados['nome'];?>" id="turma" class="form-control col-md-7 col-xs-12"placeholder="Preencha nome da turma.." required type="text">
                        </div>
                      </div>
