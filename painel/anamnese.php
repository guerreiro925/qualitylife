          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h1 class="text-center">Anamnese</h1>
                    <div class="clearfix"></div>
                  </div>
                  <div class="x_content">
                    <a href="anamnese_incluir.php" style="color: #fff">
					<p class="btn btn-dark">
                        <i class="fa fa-plus-circle"></i>&nbsp;Adicionar anamnese
					</p>
					</a>
                    <table id="datatable-responsive" class=" table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                      <thead>
                        <tr>
                          	<th>Código</th>
                          	<th class="contoth">Tipo de pessoa</th>
							<th class="contoth">Cargo</th>
							<th class="contoth">Usuário</th>
							<th class="contoth">Doença anterior</th>
							<th class="contoth">Doença familiar</th>
							<th class="contoth">Cirurgia de internação</th>
							<th class="contoth">Medicação</th>
							<th class="contoth">Alergia</th>
							<th class="contoth">Número de refeições</th>
							<th class="contoth">Atividade física</th>
							<th class="contoth">Quantidade na semana</th>
							<th class="contoth">Duração</th>
							<th class="contoth">Intensidade</th>
							<th class="contoth">Esforço</th>
							<th>Ações</th>
                        </tr>
                      </thead>
<?php
$consulta = mysql_query("SELECT * FROM anamnese WHERE deletar != '1'");
while ($dados = mysql_fetch_array($consulta))
{

	?>	
                        <tr>
                        	<th><?php echo $dados['idAnamnese']; ?></th>
                        	<th class="contod"><?php echo $dados['tipo'];?></th>
							<th class="contod"><?php echo $dados['funcao'];?></th>
							<th class="contod"><?php echo $dados['pessoa'];?></th>
							<th class="contod"><?php echo $dados['doenca_anterior'];?></th>
							<th class="contod"><?php echo $dados['doenca_familiar'];?></th>
							<th class="contod"><?php echo $dados['cirurgia_internacao'];?></th>
							<th class="contod"><?php echo $dados['medicacao'];?></th>
							<th class="contod"><?php echo $dados['alergia'];?></th>
							<th class="contod"><?php echo $dados['numero_refeicoes'];?></th>
							<th class="contod"><?php echo $dados['atividade_fisica'];?></th>
							<th class="contod"><?php echo $dados['vezes_semana'];?></th>
							<th class="contod"><?php echo $dados['duracao'];?></th>
							<th class="contod"><?php echo $dados['intensidade'];?></th>
							<th class="contod"><?php echo $dados['esforco'];?></th>							
                            <td><a href="anamnese_editar.php?id=<?php echo $dados['idAnamnese'];?>"><i class="fa fa-pencil-square" style="font-size: 20px"></i></a><a href="controlador.php?acao=excluir_anamnese&id=<?php echo $dados['idAnamnese'];?>"><i class="fa fa-trash-o" style="font-size: 20px"></i></a></td>
                        </tr>
<?php } ?>
                    </table>
