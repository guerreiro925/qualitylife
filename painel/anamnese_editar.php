...
<html>
  ...
  <body class="nav-md">
	...
	<?php
	$id = $_GET['id'];
	$resultado = mysql_query("SELECT * FROM anamnese WHERE idAnamnese = '$id'");
	while($dados = mysql_fetch_array($resultado)){
	?>

                    <form class="form-horizontal form-label-left" action="controlador.php?acao=editar_anamnese" method="post" enctype="multipart/form-data" novalidate>
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="number" name="numero_atividade" value="<?php echo $dados['vezes_semana'];?>" id="numero_atividade" class="form-control col-md-7 col-xs-12" placeholder="Preencha quantas vezes realiza atividade física.." required type="text">
                        </div>
                      </div>
					  ...
					  <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="time" name="duracao_atividade" value="<?php echo $dados['duracao'];?>" id="duracao_atividade" class="form-control col-md-7 col-xs-12" placeholder="Preencha duração da atividade física.." required type="text">
                        </div>
                      </div>
					  ...
					  <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="number" name="refeicoes" id="refeicoes" value="<?php echo $dados['numero_refeicoes'];?>" class="form-control col-md-7 col-xs-12" placeholder="Preencha quantas refeições são digeridas.." required type="text">
                        </div>
                      </div>
					  ...
					  <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <textarea type="text" name="doenca_familiar" id="doenca_familiar" rows="3"  class="form-control col-md-7 col-xs-12" placeholder="Preencha as doenças da sua família.." required type="text"><?php echo $dados['doenca_familiar'];?></textarea>
                        </div>
                      </div>
					  ...
					  <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <textarea type="text" name="doenca_anterior" id="doenca_anterior" rows="3"  class="form-control col-md-7 col-xs-12" placeholder="Preencha suas doenças anteriores.." required type="text"><?php echo $dados['doenca_anterior'];?></textarea>
                        </div>
                      </div>
					  ...
					  <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <textarea type="text" name="cirurgia_internacao" id="cirurgia_internacao" rows="3"  class="form-control col-md-7 col-xs-12" placeholder="Preencha suas cirurgias/internações.." required type="text"><?php echo $dados['cirurgia_internacao'];?></textarea>
                        </div>
                      </div>
					  ...
					  <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <textarea type="text" name="medicacao" id="medicacao" rows="3"  class="form-control col-md-7 col-xs-12" placeholder="Preencha suas medicações em uso.." required type="text"><?php echo $dados['medicacao'];?></textarea>
                        </div>
                      </div>
					  ...
					  <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <textarea type="text" name="alergia" id="alergia" rows="3"  class="form-control col-md-7 col-xs-12" placeholder="Preencha suas alergias.." required type="text"><?php echo $dados['alergia'];?></textarea>
                        </div>
                      </div>
