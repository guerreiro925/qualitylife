...
else if (idade >15 && sexo =="feminino")
{
  ...
  <body class="nav-md">
	...
	<?php
	$id = $_GET['id'];
	$resultado = mysql_query("SELECT * FROM imc WHERE idImc = '$id'");
	while($dados = mysql_fetch_array($resultado)){
	?>

                    <form name="imc" class="form-horizontal form-label-left" action="controlador.php?acao=editar_imc" method="post" enctype="multipart/form-data" novalidate>
                      ...
                      <div class="item form-group">
						...
						<div class="col-md-6 col-sm-6 col-xs-12">
							<input type="number" name="peso" value="<?php echo $dados['peso'];?>" class="form-control col-md-7 col-xs-12 required" required/>
						</div>
				      </div>
					  ...
					  <div class="item form-group">
						...
						<div class="col-md-6 col-sm-6 col-xs-12">
							<input type="text" data-inputmask="'mask' : '9.99'" value="<?php echo $dados['altura'];?>" name="altura" class="form-control col-md-7 col-xs-12 required" required/>
						</div>
				      </div>
					  ...
					  <div class="item form-group">
						...
						<div class="col-md-6 col-sm-6 col-xs-12">
							<input type="number"  name="idade" value="<?php echo $dados['idade'];?>" class="form-control col-md-7 col-xs-12 required" required/>
						</div>
				      </div>
