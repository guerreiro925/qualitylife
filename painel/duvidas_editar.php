  ...
  <body class="nav-md">
    <div class="container body">
      <div class="main_container">
          ...
          <div class="left_col scroll-view">
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  <?php if($nivel == 'ADMIN'){?><li class="active"><a href="duvidas.php"><i class="zmdi zmdi-hc-2x zmdi-pin-help"></i> Dúvida <span class="badge bg-red pull-right" data-toggle="tooltip" data-placement="right" title="Total de dados"><?php echo $duvida;?></span></a></li><?php } ?>
                </ul>
                <ul class="nav side-menu">
		...
		<?php
	$id = $_GET['id'];
	$resultado = mysql_query("SELECT * FROM duvidas WHERE idDuvida = '$id'");
	while($dados = mysql_fetch_array($resultado)){
	?>		  
				  
                    <form class="form-horizontal form-label-left" action="controlador.php?acao=editar_duvida" method="post" enctype="multipart/form-data" novalidate>
					  ...
					  <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="email" name="email" id="email" value="<?php echo $dados['email'];?>" class="form-control col-md-7 col-xs-12" placeholder="Preencha um email válido.." required type="text">
                        </div>
                      </div>
					  
					  <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="">Dúvida:</label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <textarea type="text" name="pergunta" id="message1" rows="3"  class="form-control col-md-7 col-xs-12" placeholder="Preencha a sua dúvida.." required type="text"></textarea>
...
CKEDITOR.replace('pergunta');
                      ...
                      <div class="form-group">
                        <div class="col-md-6 col-md-offset-3">
                          ...
                          <button type="reset" class="btn btn-primary" onClick="window.location.href='duvidas.php'">Voltar</button>
