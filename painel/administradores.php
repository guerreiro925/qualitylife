            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                  <?php if($nivel == 'ADMIN'){?><a href="administradores_incluir.php" style="color: #fff">
                    ...
                    <table id="datatable-responsive" class=" table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                      <thead>
                        <tr>
                          	...
                          	<th class="contoth">Senha</th>
							<th class="contoth">Nível</th>
							<th class="contoth">Ações</th>
                        </tr>
                      </thead>
<?php
$consulta = mysql_query("SELECT * FROM adm WHERE deletar != '1'");
while ($dados = mysql_fetch_array($consulta))
{

	?>	
                        <tr>
                        	<th><?php echo $dados['idAdministrador']; ?></th>
                        	<th><?php echo $dados['usuario']; ?></th>
                            <td>Edite para ver a senha</td>
							<th><?php echo $dados['nivel']; ?></th>
                            <td><a href="administradores_editar.php?id=<?php echo $dados['idAdministrador'];?>"><i class="fa fa-pencil-square" style="font-size: 20px"></i></a><a href="controlador.php?acao=excluir_administrador&id=<?php echo $dados['idAdministrador'];?>"><i class="fa fa-trash-o" style="font-size: 20px"></i></a></td>
                        </tr>
<?php } ?>
                    </table>
