...
while ($dados = mysql_fetch_array($consulta))
{
	...
	?>	
                        <tr>
                            ...
                            <td><a href="usuarios_editar.php?id=<?php echo $dados['idUsuario'];?>"><i class="fa fa-pencil-square" style="font-size: 20px"></i></a><a href="controlador.php?acao=excluir_usuario&id=<?php echo $dados['idUsuario'];?>"><i class="fa fa-trash-o" style="font-size: 20px"></i></a></td>
                        </tr>
<?php } ?>
                    </table>
