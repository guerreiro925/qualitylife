  ...
  <body class="nav-md">
    <div class="container body">
      <div class="main_container">
          ...
          <div class="left_col scroll-view">
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                 <li class="active"><a href="administradores.php"><i class="zmdi zmdi-hc-2x zmdi-account-box"></i> Administrador </a></li>
                </ul>
                <ul class="nav side-menu">
		...
		<?php
	$id = $_GET['id'];
	$resultado = mysql_query("SELECT * FROM adm WHERE idAdministrador = '$id'");
	while($dados = mysql_fetch_array($resultado)){
	?>		  
				  
                    <form class="form-horizontal form-label-left" action="controlador.php?acao=editar_administrador" method="post" enctype="multipart/form-data" novalidate>
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" name="usuario" value="<?php echo $dados['usuario'];?>" id="usuario" class="form-control col-md-7 col-xs-12"placeholder="Preencha o usuário.." required type="text">
                        </div>
                      </div>
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="password" name="senha" id="senha" data-validate-length="6,7" placeholder="Preencha a senha.." required class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
					  
					  <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="">Nível:</label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <select name="nivel" id="nivel" class="form-control col-md-7 col-xs-12 required" required>
						  <option selected value>Selecione um Nível</option>
						  
                        	<option value="ADMIN">Nível Administrador</option>
							<option value="COMUM">Nível Usuário</option>
                      ...
                      <div class="form-group">
                        <div class="col-md-6 col-md-offset-3">
                          ...
                          <button type="reset" class="btn btn-primary" onClick="window.location.href='administradores.php'">Voltar</button>
