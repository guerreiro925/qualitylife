...
var validator = (function($){
    ...
    */
    message = {
        invalid         : 'Minímo 7 caracteres na senha',
        checked         : 'must be checked',
        empty           : 'Preencha o campo vazio',
        ...
        email_repeat    : 'Email não está idêntico',
        password_repeat : 'Senha não está idêntica',
        repeat          : 'no match',
        complete        : 'Respite o minímo de caracteres',
