  ...
  <body class="nav-md">
    <div class="container body">
      <div class="main_container">
          ...
          <div class="left_col scroll-view">
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  <?php if($nivel == 'ADMIN'){?><li class="active"><a href="slides.php"><i class="zmdi zmdi-hc-2x zmdi-image"></i> Slide</a></li><?php } ?>
                </ul>
                <ul class="nav side-menu">
		...
		<?php
	$id = $_GET['id'];
	$resultado = mysql_query("SELECT * FROM slide WHERE idSlide = '$id'");
	while($dados = mysql_fetch_array($resultado)){
	?>		  
				  
                    <form class="form-horizontal form-label-left" action="controlador.php?acao=editar_slide" method="post" enctype="multipart/form-data" novalidate>
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" name="descricao" id="descricao" value="<?php echo $dados['descricao'];?>" class="form-control col-md-7 col-xs-12" placeholder="Preencha a descrição.." required type="text">
                        </div>
                      </div>
					  ...
					  <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="file" name="imagem" id="imagem" value="<?php echo $dados['imagem'];?>" class="form-control col-md-7 col-xs-12"  required ><br>
						  <img class="img-responsive" src="<?php echo $dados['imagem'];?>" width="100" height="100"/>
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        <div class="col-md-6 col-md-offset-3">
                          ...
                          <button type="reset" class="btn btn-primary" onClick="window.location.href='slides.php'">Voltar</button>
