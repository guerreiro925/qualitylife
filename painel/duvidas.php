            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                  <a href="duvidas_incluir.php" style="color: #fff">
					<p class="btn btn-dark">
                        <i class="fa fa-plus-circle"></i>&nbsp;Adicionar dúvida
					</p>
				  </a>
                    <table id="datatable-responsive" class=" table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                      <thead>
                        <tr>
							...
							<th class="contoth">Dúvida</th>
							<th class="contoth">Ações</th>
                        </tr>
                      </thead>
<?php
$consulta = mysql_query("SELECT * FROM duvidas WHERE deletar != '1'");
while ($dados = mysql_fetch_array($consulta))
{

	?>	
                        <tr>
                        	<th><?php echo $dados['idDuvida']; ?></th>
							<th><?php echo $dados['nome']; ?></th>
                        	<th><?php echo $dados['email']; ?></th>
							<th><?php echo $dados['pergunta']; ?></th>			
							<td><a href="duvidas_editar.php?id=<?php echo $dados['idDuvida'];?>"><i class="fa fa-pencil-square" style="font-size: 20px"></i></a><a href="controlador.php?acao=excluir_duvida&id=<?php echo $dados['idDuvida'];?>"><i class="fa fa-trash-o" style="font-size: 20px"></i></a></td>
                        </tr>
<?php } ?>
                    </table>
