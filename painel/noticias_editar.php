  ...
  <body class="nav-md">
    <div class="container body">
      <div class="main_container">
          ...
          <div class="left_col scroll-view">
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  <li class="active"><a href="noticias.php"><i class="zmdi zmdi-hc-2x zmdi-edit"></i> Notícia<span class="badge bg-red pull-right" data-toggle="tooltip" data-placement="right" title="Total de dados"><?php echo $noticia;?></span></a></li>
                </ul>
                <ul class="nav side-menu">
		...
		<?php
	$id = $_GET['id'];
	$resultado = mysql_query("SELECT * FROM noticias WHERE idNoticia = '$id'");
	while($dados = mysql_fetch_array($resultado)){
	?>		  
				  
                    <form class="form-horizontal form-label-left" action="controlador.php?acao=editar_noticia" method="post" enctype="multipart/form-data" novalidate>

                      <p>Preencha corretamente os campos para realizar a edição </p>
                      <span class="section"><p><?php error_reporting(0); if($_GET['msg'] == 'ok'){echo 'Registro alterado com sucesso.';} else if($_GET['msg'] == 'error'){echo 'Erro ao editar dados, tente novamente mais tarde.';}?></p>
</span>
                      ...
                      <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="">Titulo:</label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" name="titulo" id="titulo" value="<?php echo $dados['titulo'];?>" class="form-control col-md-7 col-xs-12" placeholder="Preencha um título.." required type="text">
                        </div>
                      </div>
					  
					  <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="">Resumo:</label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" name="resumo" id="resumo" value="<?php echo $dados['resumo'];?>" class="form-control col-md-7 col-xs-12" placeholder="Preencha um resumo.." required type="text">
                        </div>
                      </div>
					  ...
					  <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
						  <input type="file" name="imagem" id="imagem" value="<?php echo $dados['imagem'];?>" class="form-control col-md-7 col-xs-12" placeholder="Preencha uma imagem.." ><br>
						  <img src="<?php echo $dados['imagem'];?>" width="60" height="60" class="img-responsive col-xs-offset-5">
                        </div>
                      </div>
					  
                       <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="">Conteúdo:</label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <textarea type="text" name="conteudo" id="message1" rows="3"  class="form-control col-md-7 col-xs-12" placeholder="Preencha o conteúdo.." required type="text"><?php echo $dados['conteudo'];?></textarea>
...
CKEDITOR.replace('conteudo');
					  ...
					  <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <select name="categoria" id="categoria" class="form-control col-md-7 col-xs-12 required" required type="text">
...
while ($dados = mysql_fetch_array($consulta))
	{
					?>
					  ...
					  <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="">Data:</label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="date" name="data" id="data" value="<?php echo $dados['data'];?>" class="form-control col-md-7 col-xs-12" placeholder="Preencha uma data.." required type="text">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        <div class="col-md-6 col-md-offset-3">
                          ...
                          <button type="reset" class="btn btn-primary" onClick="window.location.href='noticias.php'">Voltar</button>
