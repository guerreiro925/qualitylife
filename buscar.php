...
<html lang="zxx">
<head>
<title>Notícias | Qualidade de Vida</title>    
...
<body>
	...
	<!-- navigation -->
			  ...
			  <div class="container-fluid">
				...
				<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
				  <ul class="nav navbar-nav">
					...
					<li class="dropdown">
					  <a href="#" class="dropdown-toggle active" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Categoria <span class="caret"></span></a>
					  <ul class="dropdown-menu">
						<?php 
									...
									<li><a href="categorias.php?id=<?php echo $dados['idCategoria']; ?>"><?php echo $dados['nome']; ?></a></li>
									<?php } ?>
					  </ul>
					</li>
		...
		<div class="agileits Blog">
			<div class="container">
				<h2 class="agile-inner-title">Todas as Noticias</h2><br><br>
				<!-- news -->
...
$date = $dados['data'];
 ...
 <span><?php echo strftime("%d", strtotime($date));?></h4>
...
{
	$consulta= mysql_query ("SELECT * FROM noticias WHERE deletar != 1 LIKE '%$busca%' OR titulo LIKE '%$busca%' OR resumo LIKE '%$busca%' OR conteudo LIKE '%$busca%'");
...
$date = $dados['data'];				?>
 ...
 <span><?php echo strftime("%d", strtotime($date));?></h4>
	...
	echo "Não existe essa Ordem de Serviço <a href='pesquisar_os.php'>tente novamente</a>";
...
<!-- //news -->
		...
		<footer>
			<div class="container">
				<div class="w3ls-footer-grids" class="col-md-12" >					
